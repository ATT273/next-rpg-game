...
const ClassesSelection = ({
  ...
  useEffect(() => {
    ...
    handleUpdateClassData({
      ...
      stats: { ...classes[classKeys[activeClass] as keyof typeof classes].stats },
      skills: [],
    });
    ...
    <div className="w-full">
      <div className="class-container w-full">
        <div className="class-image relative flex justify-center items-center h-full max-w-[350px] m-auto mb-5 overflow-hidden">
          <motion.div className="flex flex-nowrap" animate={{ x: xValue }}>
        ...
        <div className="flex flex-col justify-center items-center text-slate-900">
          ...
          <br />
          <SkillSelection
            skills={classes[classKeys[activeClass] as keyof typeof classes].skills}
            selectedSkill={selectedSkill.key}
            handleChooseSkill={handleSkillSelected}
          />
        </div>
      </div>
    </div>
